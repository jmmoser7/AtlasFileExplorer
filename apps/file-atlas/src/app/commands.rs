...
pub const SPECS: &[CommandSpec] = &[
    ...
    gesture(
        "timeline.pan",
        "Activity timeline pan",
        "Timeline",
        "Right-drag anywhere over the timeline, or scroll wheel (earlier / later in time)",
        ATLAS,
    ),
    gesture(
        "timeline.zoom",
        ...
        "Timeline",
        "Ctrl+scroll wheel over the timeline (anchored at the cursor; \
         weekday columns stagger into per-day slots, then expand to a \
         bucket strip and per-file dashes)",
        ATLAS,
    ),
    gesture(
        "timeline.fit",
        "Activity timeline fit",
        "Timeline",
    ...
    gesture(
        "timeline.drag_pan",
        "Activity timeline drag-pan",
        "Timeline",
        "Right-drag anywhere over the timeline — same button that pans the canvas",
        ATLAS,
    ),
    gesture(
        "timeline.range",
        ...
        "Timeline",
        "Drag either handle (snaps to the bucket grain on screen)",
        ATLAS,
    ),
    gesture(
        "timeline.scrub",
        "Date window scrub",
        "Timeline",
        "Left-drag between the two handles (keeps the window width; only once the \
         window is narrower than the whole span)",
        ATLAS,
    ),
    gesture(
        "timeline.subselect",
        "New date window from a drag",
        "Timeline",
        "Left-drag across the graph or bare rail (works with both handles off screen)",
        ATLAS,
    ),
    gesture(
        "timeline.pick",
        "Select one bucket",
        "Timeline",
        "Click a bucket · Shift+click extends from the anchor",
        ATLAS,
    ),
    gesture(
        "timeline.toggle",
        "Toggle one bucket in the window",
        "Timeline",
        "Ctrl+click a bucket (punches it out of the window, or restores it)",
        ATLAS,
    ),
    gesture(
        "timeline.reset",
        ...
        "Timeline",
        "Reset button left of the rail · \"clear selection\" · Escape",
        ATLAS,
    ),
    spec(
        "canvas.search",
    ...
    spec(
        "atlas.download_cloud",
        "Download cloud files for previews",
        "Workflow",
        "File → Download cloud files…",
        None,
        Repeat::Never,
        ATLAS,
        &["onedrive", "hydrate", "offline", "placeholder"],
    ),
    spec(
        "app.undo",
        "Undo",
