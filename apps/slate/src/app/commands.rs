...
pub static SPECS: &[CommandSpec] = &[
    ...
    spec(
        ...
        "Board",
        "Agent portal: switch chat",
        "Right-click a bound agent portal; pick a saved Cursor chat for that folder (not a live IDE-thread attach)",
        None,
        Repeat::Never,
        BOARD,
        &["switch chat", "agent chat", "cursor chat"],
    ),
    spec(
        "stage.accept",
        "Board",
