...
pub static SPECS: &[CommandSpec] = &[
    ...
    spec("board.media.page", "Media", "Media: show page", "Click a page in the PDF / PowerPoint page picker", None, Repeat::Never, Availability::BOARD_VIEW, &["slide", "page", "poster page"]),
    ...
    spec(
        ...
        "Board",
        "Repository Lens portal",
        "Palette: repository lens; a small portal ghost follows the pointer; click or drag (Board view)",
        None,
        Repeat::Never,
        BOARD,
        &["repo lens", "git graph", "history portal"],
    ),
    spec(
        "board.portal.status_board",
        "Board",
        "Status Board portal",
        "Palette: status board; a small portal ghost follows the pointer; click or drag (Board view)",
        None,
        Repeat::Never,
        BOARD,
        &["status portal", "project status", "roadmap portal"],
    ),
    spec(
        "portal.status.source",
        "Board",
        "Status Board: choose snapshot",
        "Portal sidebar or empty-state button; binds a local project-state.json or its folder",
        None,
        Repeat::Never,
        BOARD,
        &["choose status snapshot", "bind status"],
    ),
    spec(
        "portal.status.refresh",
        "Board",
        "Status Board: refresh",
        "Portal sidebar; reloads the bound snapshot and re-lays-out",
        None,
        Repeat::Repeatable,
        BOARD,
        &["status refresh"],
    ...
    spec(
        "portal.status.bake",
        "Board",
        "Status Board: bake snapshot",
        "Portal sidebar; promotes current derived status contents to authored board nodes",
        None,
        Repeat::Never,
        BOARD,
        &["status bake", "freeze status"],
    ),
    spec(
        "board.portal.agent",
        "Board",
    ...
    spec(
        ...
        "Agent portal inspector; writes request.json for the linked local agent",
        None,
        Repeat::Never,
        BOARD,
    ...
    spec(
        "portal.repo.source",
        "Board",
        "Repository Lens: choose source",
        "Portal sidebar or empty-state button; binds a local git worktree / bare repo",
        None,
        Repeat::Never,
        BOARD,
        &["choose repository", "bind repository"],
    ),
    spec(
        "portal.repo.refresh",
        "Board",
        "Repository Lens: refresh",
        "Portal sidebar; re-extracts refs and commits from the local object database",
        None,
        Repeat::Repeatable,
        BOARD,
        &["repo refresh"],
    ...
    spec(
        "portal.repo.bake",
        "Board",
        "Repository Lens: bake snapshot",
        "Portal sidebar; promotes current derived graph contents to authored board nodes",
        None,
        Repeat::Never,
        BOARD,
        &["repo bake", "freeze history"],
    ),
    spec(
        "portal.repo.focus",
        "Board",
        "Repository Lens: focus commit/ref",
        "Click inside a focused interactive portal; Esc clears focus",
        None,
        Repeat::Repeatable,
        BOARD,
    ...
    spec(
        "portal.repo.branch_create",
        "Board",
        "Repository Lens: create branch (human write-back)",
        "Explicit per-action write-back; names target commit and branch, never available to agents",
        None,
        Repeat::Never,
        BOARD,
        &["repo branch"],
    ...
    spec(
        "portal.repo.merge",
        "Board",
        "Repository Lens: merge branch (human write-back)",
        "Explicit per-action write-back; names source and target refs, never available to agents",
        None,
        Repeat::Never,
        BOARD,
        &["repo merge"],
    ...
    spec(
        "portal.repo.checkout",
        "Board",
        "Repository Lens: checkout ref (human write-back)",
        "Explicit per-action write-back; names target ref, never available to agents",
        None,
        Repeat::Never,
        BOARD,
        &["repo checkout"],
