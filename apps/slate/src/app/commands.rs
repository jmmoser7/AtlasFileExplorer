...
pub static SPECS: &[CommandSpec] = &[
    ...
    spec(
        ...
        "Board",
        "Web portal",
        "Palette: web portal; a small portal ghost follows the pointer; click or drag; drag a browser tab, paste a URL, or drop an .html file / index.html folder (Board view)",
        None,
        Repeat::Never,
        BOARD,
        &[
    ...
    spec(
        ...
        "Hover the identity tab and click the chevron to fold it; hover the top interior to restore",
        None,
        Repeat::Never,
        BOARD,
