...
//! collapse grips, file cards, group-preview mosaics, the packed image sheet,
//! and the File Atlas camera (`screen = world × z + offset`). Window chrome
//! stays out of this module (Art. X). Apps supply scan/thumbs and decide
//! which Atlas-only gestures (Edit drag, shell drag-out) are armed.
