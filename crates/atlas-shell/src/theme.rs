...
//!
//! Both File Atlas and Slate build their visuals from [`Palette`] and the
//! [`dark_visuals`] / [`light_visuals`] presets. Apps must not define their
//! own color constants for chrome — divergence between the apps is a bug.
