...
| D14 | Post-edit | Circular Fill and Stroke buttons; no corner button. Color editors open outward and use the shared desktop eyedropper. Dimension alternatives are in shape-property-editing.md. | guess | 55 |
...
Circular Fill and Stroke buttons; no corner button. Color editors open outward and use the shared desktop eyedropper. Dimension alternatives are in shape-property-editing.md. Stringers: Propose one diameter stringer for a circle; two local-axis diameters for an ellipse. Edits stay centered; a circle stays circular. Alternative: radius/radii labels instead of diameter. No size fields in the toolbar.
...
- **GP1:** Select ellipse -> no rectangle corner fields.
- **GP2:** Set Rx=60, Ry=30 -> width 120 and height 60; explicit circle constraint makes both axes equal.
- **GP3:** Multi-select ellipses with differing dimensions -> Mixed; a fill change leaves dimensions untouched.
