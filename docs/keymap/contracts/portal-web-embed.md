...
14. **GP14 — fold tab:** hover the tab, click the chevron → the tab hides;
    hover the top interior and click the reveal → the tab returns. Works in
    both ordinary and maximize mode.
