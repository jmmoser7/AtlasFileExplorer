...
| D05 | Modifiers | P2.GhostFollow.place. During DragScale only. GhostFollow ignores modifiers. Rectangle and ellipse: Ctrl draws from the press point as center; Shift still locks aspect. Alt suspends snaps. Other DragRect tools have no Ctrl create modifier. | stated | 100 |
